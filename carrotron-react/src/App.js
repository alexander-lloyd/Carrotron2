...
import './App.css';
import { Navbar, NavItem, Button, Card, Row, Col } from 'react-materialize';
...
class App extends Component {
  ...
  drawRobot() {
    ...
    this.ctx.fillRect(375, 610, 50, 50);
  }
  ...
  render() {
    return (
      <div className="App">
        ...
        <canvas ref="myCanvas" width="800" height="800" style={{border: 1 + 'px solid'}} />
      </div>
    );
  }
}
